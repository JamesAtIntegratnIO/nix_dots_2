...
| **pcmanfm** (files) | `Super+f` | **Single tap opens** files/folders. |
...
| **pavucontrol** | — | Full audio mixer if the volume menu isn't enough. |
...
- **Highlight-to-copy**: selecting text mirrors to the clipboard — `Ctrl+V` to
  paste anywhere.
- **Open a URL**: `Ctrl+click` it (or `Ctrl+Shift+u`, then the letter tag) —
  opens in Firefox.
